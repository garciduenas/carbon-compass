  ...
  return (
    <div className="min-h-svh bg-background text-foreground">
        ...
        <main className="max-w-4xl mx-auto px-6 pt-24 pb-32 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 text-balance text-foreground">
              The logistics of <br className="hidden md:block" />
          ...
          {isProcessing && (
            ...
            >
              ...
              <span className="text-sm text-muted-foreground">Calculating optimal pathways...</span>
            </motion.div>
          )}
      ...
      <section className="max-w-4xl mx-auto px-6 py-32 text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-6 text-foreground tracking-tight">Ready to automate<br />your footprint?</h2>
        <p className="text-muted-foreground text-lg mb-10 max-w-xl mx-auto">Join thousands of people optimizing their carbon impact with AI-powered recommendations.</p>
